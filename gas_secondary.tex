...
\EQ
(\beta_l)_{jk} \eq  A_{l,l-1}\left[\left( - \frac{\varphi D^{aq}}{d_l + d_{l-1}} - q_{l,l-1} \right)\frac {\partial\Psi_{j,l-1}^{aq}}{\partial lnC_{k,l-1}} + \left( - \frac{\varphi D^{g}}{d_l + d_{l-1}} - q_{l,l-1} \right)\frac {\partial\Psi_{j,l-1}^{g}}{\partial C_{k,l-1}^{aq}} \right]
\EN
...
\EQ
(\gamma_l)_{jk} \eq  A_{l,l+1} \left[\left( - \frac{\varphi D^{aq}}{d_{l+1} + d_l} + q_{l,l+1} \right) \frac{\partial\Psi_{j,l+1}^{aq}}{\partial lnC_{k,l+1}^{aq}} + \left( - \frac{\varphi D^g}{d_{l+1} + d_l} + q_{l,l+1} \right) \frac{\partial\Psi_{j,l+1}^g}{\partial C_{k,l+1}^{aq}} \right]
\EN
